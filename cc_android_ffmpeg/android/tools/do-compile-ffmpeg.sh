...
if [ "$FF_ARCH" = "armv7a" ]; then
	...
	FF_BUILD_NAME_MP3LAME=mp3lame/src/main/obj/local/armeabi-v7a
    ...
    FF_SOURCE=$FF_BUILD_ROOT/../ijk-0-6-3-ffmpeg-3-1-armv7a
	...
	FF_BUILD_NAME_MP3LAME=mp3lame/src/main/obj/local/x86
	...
	FF_BUILD_NAME_MP3LAME=mp3lame/src/main/obj/local/x86_64
	...
	FF_BUILD_NAME_MP3LAME=mp3lame/src/main/obj/local/arm64-v8a
...
FFMPEG_DEP_MP3LAME_INC=$FF_BUILD_ROOT/$FF_BUILD_NAME_MP3LAME
FFMPEG_DEP_MP3LAME_LIB=$FF_BUILD_ROOT/$FF_BUILD_NAME_MP3LAME
...
# FF_CFG_FLAGS="$FF_CFG_FLAGS --enable-nonfree"
    FF_CFG_FLAGS="$FF_CFG_FLAGS --enable-openssl --enable-libmp3lame"

    FF_CFLAGS="$FF_CFLAGS -I${FF_DEP_OPENSSL_INC} -I${FFMPEG_DEP_MP3LAME_INC}"
    FF_DEP_LIBS="$FF_DEP_LIBS -L${FF_DEP_OPENSSL_LIB} -lssl -lcrypto -L${FFMPEG_DEP_MP3LAME_LIB} -lmp3lame"
fi
...
echo "FF_MODULE_DIRS: $FF_MODULE_DIRS"
echo "--------------------"
